...
"""Test freedomcoind with different proxy configuration.

Test plan:
- Start freedomcoind's with different proxy configurations
- Use addnode to initiate connections
- Verify that proxies are connected to, and the right connection command is given
- Proxy configurations to test on freedomcoind side:
