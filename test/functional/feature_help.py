...
"""Verify that starting freedomcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start freedomcoin with -h for help text")
        ...
        self.log.info("Start freedomcoin with -version for version information")
        ...
        self.log.info("Start freedomcoind with -fakearg to make sure it does not start")
