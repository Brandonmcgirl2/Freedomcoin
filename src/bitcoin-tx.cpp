...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " freedomcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  freedomcoin-tx [options] <hex-tx> [commands]  Update hex-encoded freedomcoin transaction\n" +
            "or:     freedomcoin-tx [options] -create [commands]   Create hex-encoded freedomcoin transaction\n" +
            "\n";
