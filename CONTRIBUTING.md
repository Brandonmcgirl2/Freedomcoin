Contributing to Freedomcoin Core
============================

The Freedomcoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Freedomcoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/freedomcoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to freedomcoin-qt
...
The following applies to code changes to the Freedomcoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Freedomcoin
Network Protocol consensus changes.

Whether a pull request is merged into Freedomcoin Core rests with the project merge
...
Patches that change Freedomcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Freedomcoin consensus, it must have been
...
The project leader is the release manager for each Freedomcoin Core release.
