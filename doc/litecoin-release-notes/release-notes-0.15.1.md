Freedomcoin Core version *0.15.1* is now available from:

  <https://download.freedomcoin.org/freedomcoin-0.15.1/>
...
A number of changes to the way Freedomcoin Core deals with peer connections and invalid blocks
