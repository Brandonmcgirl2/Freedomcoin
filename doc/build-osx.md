...
2.  Build Freedomcoin Core:
    ...
    Configure and build the headless Freedomcoin Core binaries as well as the GUI (if Qt is found).
...
## Disable-wallet mode
When the intention is to run only a P2P node without a wallet, Freedomcoin Core may be
...
The first time you run freedomcoind, it will start downloading the blockchain. This process could
