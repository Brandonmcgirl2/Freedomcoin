# Support for Output Descriptors in Freedomcoin Core

Since Freedomcoin Core v0.17, there is support for Output Descriptors. This is a
...
existing Freedomcoin Core wallets, a convenience function `combo` is
